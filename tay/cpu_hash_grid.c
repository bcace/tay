...
static void _see_func(_SeeTask *task, TayThreadContext *thread_context) {
    ...
    CpuHashGrid *seer_grid = &seer_space->cpu_hash_grid;
    CpuHashGrid *seen_grid = &seen_space->cpu_hash_grid;
...
void cpu_hash_grid_see(TayPass *pass) {
    ...
    CpuHashGrid *seer_grid = &pass->seer_space->cpu_hash_grid;
...
void cpu_hash_grid_act(TayPass *pass) {
    ...
    CpuHashGrid *grid = &pass->act_space->cpu_hash_grid;
...
void cpu_hash_grid_on_simulation_start(Space *space) {
    CpuHashGrid *grid = &space->cpu_hash_grid;
