...
const char *default_frag = "#version 130\n \
\n \
in vec4 _color;\n \
\n \
out vec4 color;\n \
...
const char *default_vert = "#version 130\n \
\n \
in vec3 pos;\n \
in vec4 color;\n \
\n \
...
const char *shaded_instanced_vert = "#version 130\n \
\n \
in vec3 pos;\n \
in vec3 inst_pos;\n \
\n \
...
const char *test_frag = "#version 130\n \
\n \
out vec4 color;\n \
\n \
\n \
...
const char *test_vert = "#version 130\n \
\n \
in vec3 pos;\n \
\n \
uniform mat4 projection;\n \
